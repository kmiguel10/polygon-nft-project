...
const highTokenUri =
  "data:application/json;base64,";
const lowTokenUri =
...
describe("Dynamic SVG NFT Unit Tests", function () {
  ...
  describe("constructor", () => {
    it("sets starting values correctly", async function () {
      ...
      const testName = await dynamicSvgNft.getName();
      const testNftSymbol = await dynamicSvgNft.getNftSymbol();
      assert.equal(lowSVG, lowSVGImageuri);
      assert.equal(highSVG, highSVGimageUri);
      assert.equal(priceFeed, mockV3Aggregator.address);
      assert.equal(testName, name);
      assert.equal(testNftSymbol, nftSymbol);
    });
  });

  describe("mintNft", () => {
    it("emits an event and creates the NFT", async function () {
      await expect(dynamicSvgNft.mint()).to.emit(dynamicSvgNft, "CreatedNFT");
